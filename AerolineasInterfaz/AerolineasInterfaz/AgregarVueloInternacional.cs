...
{
    public partial class AgregarVueloInternacional : Form
    {
        ...
        private void AgregarVueloInternacional_Load(object sender, EventArgs e)
        {
            if (destinos.Count == 0)
            {
        ...
        private void btbAltaVuelo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string pais = txtPais.Text.ToString();
                ...
                var vuelo = new VueloInternacional(destino, partida, llegada, asientos, pais, ciudad, 0, 0);

                string mensaje = aerolineaLogica.Vuelos.VueloAñadir(null,vuelo);
